...
<html:form action="/logoff" method="POST">
...
<table width="793" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
  	<td style="border-right-style:solid; border-right-width:1; border-bottom-style:solid; border-bottom-width:1;border-left-style:solid; border-left-width:1; border-top-style:solid; border-top-width:1" bordercolor="darkorange" height="424" width="100%">
    <img border="0" src="images/HRSApplicationImage.jpg" width="800" height="373"></td>
  </tr>
</table>
</body>
</html:form>
